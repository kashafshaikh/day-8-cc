...
import { calculateArea,calculatePerimeter } from "./rectangleUtils";

console.log (`Area of rectangle : ${calculateArea(5,10)}`);  //output : 50
console.log (`Perimeter of rectangle : ${calculatePerimeter(5,10)}`);  //output : 30
...
console.log (`Shape : ${myCircle.name}`);  //output : Circle
console.log (`Area : ${myCircle.area}`);   //output : 78.53981633974483
